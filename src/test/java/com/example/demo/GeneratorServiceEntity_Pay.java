...
public class GeneratorServiceEntity_Pay {
    ...
    public static void main(String[] args) {
        ...
        String moduleName = "";
        GeneratorServiceEntity_Pay entity = new GeneratorServiceEntity_Pay();
        entity.initParam();
        String[] tables = {
                ...
                "pay_bank_account",
                "pay_corp_info",
                "pay_merchant_bill_detail",
                "pay_merchant_account_bill",
                "pay_reconcile_result",
                "pay_reconcile_detail",
                "pay_trade_payment_order",
                "pay_channel",
    ...
    private void initParam() {
        password = "root";
        username = "root";
        datasourceUrl = "jdbc:mysql://10.124.68.142:3306/qhcx_pay?allowMultiQueries=true&useUnicode=true&characterEncoding=UTF-8&useSSL=true&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&tinyInt1isBit=false&serverTimezone=GMT%2B8&allowPublicKeyRetrieval=true";
    }
